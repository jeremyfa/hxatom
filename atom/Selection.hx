...
@:jsRequire("atom", "Selection") extern class Selection {
	...
	**/
	function onDidChangeRange(callback:{ var oldBufferRange : atom.Range; var oldScreenRange : atom.Range; var newBufferRange : atom.Range; var newScreenRange : atom.Range; var selection : atom.Selection; } -> Void):atom.Disposable;
	/**

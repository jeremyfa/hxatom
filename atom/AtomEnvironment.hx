...
**/
package atom;
@:jsRequire("atom", "AtomEnvironment") extern class AtomEnvironment {
	/**
	...
	**/
	function getLoadSettings():Dynamic<Dynamic>;
	/**
		Open a new Atom window using the given options.
	**/
	function open(params:{ var pathsToOpen : Array<Dynamic>; var newWindow : Bool; var devMode : Bool; var safeMode : Bool; }):Dynamic;
	/**
	...
	**/
	function confirm(options:{ var message : String; @:optional

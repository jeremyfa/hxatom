...
@:jsRequire("atom", "GrammarRegistry") extern class GrammarRegistry {
	...
	**/
	function onDidAddGrammar(callback:atom.Grammar -> Void):atom.Disposable;
	/**
		Invoke the given callback when a grammar is updated due to a grammar
		it depends on being added or removed from the registry.
	**/
	function onDidUpdateGrammar(callback:atom.Grammar -> Void):atom.Disposable;
	/**
	...
	**/
	function readGrammar(grammarPath:String, callback:js.Error -> atom.Grammar -> Void):Dynamic;
	/**
	...
	**/
	function loadGrammar(grammarPath:String, callback:js.Error -> atom.Grammar -> Void):Dynamic;
}
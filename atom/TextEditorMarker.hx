...
**/
package atom;
@:jsRequire("atom", "TextEditorMarker") extern class TextEditorMarker {
	/**
	...
	**/
	...
	function isEqual(other:atom.TextEditorMarker):Bool;
	/**
		Compares this marker to another based on their ranges.
	**/
	function compare(other:atom.TextEditorMarker):Float;
	/**
